...
class Panda2ImpedanceController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  std::unique_ptr<dynamic_reconfigure::Server<franka_example_controllers::panda_2_compliance_paramConfig>>
      panda_2_dynamic_server_compliance_param_;
  ros::NodeHandle panda_2_dynamic_reconfigure_compliance_param_node_;
  void complianceParamCallback(franka_example_controllers::panda_2_compliance_paramConfig& config,
                               uint32_t level);
